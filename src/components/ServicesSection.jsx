  ...
  return (
    <div className="flex flex-col lg:flex-row max-w-[1440px] w-full items-start gap-1 self-stretch">
      ...
      <div className="flex flex-col justify-center items-start gap-1 w-full lg:w-[40%]">
        {/* gig card 1 */}
        <div className="flex flex-col pt-6 md:pt-12 lg:pt-[8.5rem] px-6 md:px-12 lg:px-16 pb-6 md:pb-6 lg:pb-16 items-start gap-5 self-stretch rounded-3xl bg-linear-[180deg] from-[#dbdde00a] from-0% to-[#0049f50a] to-100%">
